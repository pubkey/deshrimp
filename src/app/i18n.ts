...
const de = {
    ...
    lastSixtyHint: 'Blass gerade, kräftig am Kippen, korallrot schief. Älteste links.',
...
const en: Copy = {
    ...
    lastSixtyHint: 'Faint straight, stronger tipping, coral crooked. Oldest on the left.',
